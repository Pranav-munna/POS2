 ...
 */
class RequestProducts(con: Context, rhandler: ProcessResponcceInterphase<Array<ResponceProducts>>) : AbstractRequest<Array<ResponceProducts>>(con, rhandler) {

    fun getProducts(id: String, page: Int) {
        val call = pOSInterphase.getProducts(id,page)
        call.enqueue(this)
    }
}