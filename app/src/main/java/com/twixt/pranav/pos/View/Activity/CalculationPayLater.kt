...
import com.twixt.pranav.pos.View.Fragment.FragmentCalculation
import com.twixt.pranav.pos.View.Fragment.FragmentCalculationPayLater

class CalculationPayLater : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            ...
            val fragmentcalculation = FragmentCalculationPayLater()
            fragmentcalculation.setArguments(bundle)

            supportFragmentManager.beginTransaction()
                    .add(R.id.main_activity, fragmentcalculation, "Calculation")
                    .commit()
        }
    }
